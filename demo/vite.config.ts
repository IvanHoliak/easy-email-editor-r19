...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@ivanholiak/easy-email-editor/lib/style.css': path.resolve(__dirname, 'package.json'),
      '@ivanholiak/easy-email-extensions/lib/style.css': path.resolve(__dirname, 'package.json'),
      ...
      '@ivanholiak/easy-email-core': path.resolve('../packages/easy-email-core/src/index.tsx'),
      'easy-email-editor/lib/locales.json': path.resolve(
        '../packages/easy-email-editor/public/locales.json',
      ),
      '@ivanholiak/easy-email-editor/lib/locales.json': path.resolve(
        '../packages/easy-email-editor/public/locales.json',
      ),
      ...
      '@ivanholiak/easy-email-editor': path.resolve('../packages/easy-email-editor/src/index.tsx'),
